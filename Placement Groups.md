...
```suggestion
See the See the [Java Placement Groups demo](https://github.com/ray-project/ray/blob/master/java/test/src/main/java/io/ray/docdemo/PlacementGroupDemo.java) for more information.  
...
.. note::
  ...
  and have the proper resources. Ray assumes that the placement group is properly created and does *not*
...
.. note::
  ...
  Ray automatically schedules children tasks and actors to the same placement group as its parent.
